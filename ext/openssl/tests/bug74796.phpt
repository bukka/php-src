...
--FILE--
<?php
$caCertFile = __DIR__ . DIRECTORY_SEPARATOR . 'bug74796-ca.pem.tmp';
$clientCertFile = __DIR__ . DIRECTORY_SEPARATOR . 'bug74796-client.pem.tmp';
$serverCertFile = __DIR__ . DIRECTORY_SEPARATOR . 'bug74796-server.pem.tmp';
...
$clientCode = <<<'CODE'
    ...
    // First HTTPS request
    var_dump(file_get_contents("https://bug74796-server/", false, $clientCtx));
...
$certificateGenerator->saveNewCertAsFileWithKey('bug74796-client', $clientCertFile);
$certificateGenerator->saveNewCertAsFileWithKey('bug74796-server', $serverCertFile);
...
--CLEAN--
<?php
@unlink(__DIR__ . DIRECTORY_SEPARATOR . 'bug74796-ca.pem.tmp');
@unlink(__DIR__ . DIRECTORY_SEPARATOR . 'bug74796-client.pem.tmp');
@unlink(__DIR__ . DIRECTORY_SEPARATOR . 'bug74796-server.pem.tmp');
?>
--EXPECTF--
